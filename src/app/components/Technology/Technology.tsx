...
// techonolgy section less technical
{
  /* <Accordion>
          <AccordionSummary
            sx={{
          ...
          >
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>
              At the heart of NTP is nuclear fission, a process where atoms are
              split to release significant energy. In NTP systems, this energy
              isn't converted to electricity but directly used to heat
              propellant.
            </Typography>
            <Typography
              variant="h5"
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>
              The heated propellant, typically liquid hydrogen due to its high
              efficiency, rapidly expands and is expelled through the
              spacecraft's nozzles. This expulsion generates the thrust that
              propels the spacecraft forward, much like letting air out of a
              balloon.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography sx={{ fontWeight: 'bold' }}>Key Components</Typography>
          </AccordionSummary>
          <AccordionDetails
            sx={{
              borderTop: '1px solid rgba(0, 0, 0, .125)'
          ...
          >
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>
              The reactor core is where the magic happens. It contains nuclear
              fuel (like Uranium) and is designed to sustain a controlled
              nuclear reaction. Advanced materials capable of withstanding
              extreme heat and radiation are used to construct the core.
            </Typography>
            <Typography
              variant="h5"
              sx={{
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>
              Safety is paramount in NTP. Systems are in place to precisely
              control the nuclear reaction. Control rods can adjust the reaction
              rate, while advanced cooling systems manage the reactor's intense
              heat.
            </Typography>
            <Typography
              variant="h5"
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>
              Here, heat from the reactor is transferred to the propellant. This
              component is a marvel of engineering, designed to ensure maximum
        ...
        <Accordion>
          ...
          >
            <Typography variant="body1" sx={{ mb: 3 }}>
              NTP technology prioritizes safety and environmental
              considerations. Radiation shielding protects the spacecraft and
              its occupants, while rigorous safety protocols govern the handling
              of nuclear materials. We're committed to developing NTP as a safe,
              sustainable technology for space exploration.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion>
          ...
          >
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>
              NTP can achieve a higher specific impulse compared to chemical
              rockets. This means it can travel farther and faster, using less
              propellant.
            </Typography>
            <Typography
              variant="h5"
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>
              Nuclear fuel has a much higher energy density than chemical fuels.
              This translates to longer missions and the ability to carry more
              scientific instruments or other payloads.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion>
          ...
          >
            <Typography variant="body1" sx={{ mb: 3 }}>
              We're addressing challenges in materials science, reactor control,
              and safety head-on, with research aimed at making NTP not just a
              concept, but a reality. We aim to create a team to work tirelessly
              to overcome these hurdles and ensure that NTP is a safe, reliable
        ...
        <Accordion>
          ...
          >
            <Typography variant="body1" sx={{ mb: 3 }}>
              Imagine missions to Mars that take half the time, or exploring the
              outer planets with more equipment and experiments than ever
              before. NTP isn't just a new type of engine; it's a key to
              unlocking the full potential of space exploration.
            </Typography>
          </AccordionDetails>
        </Accordion> */
}
